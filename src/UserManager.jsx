    ...
    <div style={{ padding: "40px", fontFamily: "Arial, sans-serif" }}>
      ...
      >
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "14px" }}>
          <thead>
            <tr>
              <th style={{ borderBottom: "1px solid #ddd", textAlign: "left", padding: "8px" }}>Username</th>
              <th style={{ borderBottom: "1px solid #ddd", textAlign: "left", padding: "8px" }}>Role</th>
          ...
          <tbody>
            ...
            {Object.keys(users).map((name) => (
              <tr key={name}>
                <td style={{ padding: "8px", borderBottom: "1px solid #f0f0f0" }}>{name}</td>
                <td style={{ padding: "8px", borderBottom: "1px solid #f0f0f0" }}>{users[name].role}</td>
